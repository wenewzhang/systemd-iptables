...
systemctl disable shadowsocks-libev-server@con1864.service --now
systemctl disable shadowsocks-libev-server@con1865.service --now
systemctl disable shadowsocks-libev-server@con1866.service --now
systemctl disable shadowsocks-libev-server@con1867.service --now
systemctl disable shadowsocks-libev-server@con1868.service --now
systemctl disable shadowsocks-libev-server@con1871.service --now
systemctl disable shadowsocks-libev-server@con1872.service --now
systemctl disable shadowsocks-libev-server@con1873.service --now
